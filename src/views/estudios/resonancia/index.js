        ...
        return(
            <div className='estudio-resonancia'>
                <div className='wrapper-central'>
                    ...
                    ●
                    ¿Qué sucede durante el procedimiento? ​(respuesta desplegable)
                    Durante el examen el paciente será monitoreado y observado por
                    ...
                    La resonancia magnética es un estudio totalmente indoloro. Simplemente el
                    ...
                    radiación peligrosa, ni surgen complicaciones posteriores.
                    ●
                    ¿El estudio es ruidoso? ( ​ respuesta desplegable)
                    La máquina emite un ruido fuerte como de martilleo o golpes en algunas fases
                    que es totalmente normal, por lo que el paciente no debe asustarse o
                    preocuparse por ello.
                    ●
                    ¿Qué pasa si soy claustrofóbico? ​(respuesta desplegable)
                    Al tener el resonador magnético forma de túnel, cualquier persona puede
                    experimentar cierta claustrofobia. Si sos propenso a sufrir este problema,
                    previo al estudio el médico podría administrarte un tranquilizante.
                    ●
                    ¿Qué sucede si tengo piercing, prótesis, tatuaje, ortodoncia o
                    ...
                    Sujetador metálico puesto para evitar el sangrado en un
                    aneurisma intracraneal
                    Catéter con componentes metálicos que pueden tener el
                    riesgo de producir quemaduras
                    -
                    -
                    Bomba para medicamentos (por ejemplo, las utilizadas para
                    administrar insulina o analgésicos)
                    ...
                    Prótesis ortopédicas, de oído, de globo ocular, dental,
                    vascular, biliar, cardiaca.
                    Suturas o catéteres metálicos.
                    Presencia de dispositivo intrauterino o diafragma.
                    Existencia en el interior del cuerpo de trozos de balas,
                    ...
                    Los ​empastes dentales metálicos y los ​aparatos de ortodoncia en general no
                    son afectados por el campo magnético, pero sí pueden distorsionar las
                    imágenes de la cara o el cerebro.
                    ●
                    ¿Las embarazadas pueden realizarse resonancias? ​(respuesta
                    desplegable)
                    Las embarazadas o las mujeres que sospechen estar embarazadas deberán
                    ...
                    peligrosa para el feto que los rayos X o la tomografía computada (TC).
                    ●
                    ¿Las mujeres en período de lactancia pueden realizarse resonancias?
                    (respuesta desplegable)
                    Las mujeres que se encuentren en período de lactancia -es decir, que estén
